...
const ClockOutInformation = ({clock,clockout, modalDataOut }) =>{

  console.log('testing modal out data ', modalDataOut.length)
   ...
   <View style={styles.centeredView}>
      ...
      >
        ...
        <View style={styles.centeredView}>
          ...
          {
            modalDataOut.length>=5 &&<Pressable  onPress={() => setModalVisible(true)}>
...
export default ClockOutInformation;
